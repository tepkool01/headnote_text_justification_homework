// Also, something considered, was super long strings in the array, but I wasn't sure what number to place here.
...
function sanitize(array, size, direction) {
    ...
    for (let i=0, len = array.length; i < len; i++) {
        ...
        if (has_non_ascii_elements(array[i])) {
            throw "One or more of your elements contain ascii characters outside of limitations of this system."
        }
